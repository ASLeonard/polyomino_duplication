...
struct PopulationGenotype {
  ...
  PopulationGenotype() : neutral_space(simulation_params::n_tiles*4+4) {RandomiseGenotype(neutral_space); active_space.insert(active_space.end(),neutral_space.begin(),neutral_space.begin()+4); neutral_space.erase(neutral_space.begin(),neutral_space.begin()+4);};
